...
module.exports = {
  ...
  // Automatically clear mock calls and instances between every __test__
  clearMocks: true,
  ...
  // Automatically reset mock state between every __test__
  // resetMocks: false,
  ...
  // Automatically restore mock state between every __test__
  // restoreMocks: false,
  ...
  testMatch: ['**/__test__/**/*.+(ts|js)', '**/?(*.)+(spec|__test__).+(ts|js)'],
